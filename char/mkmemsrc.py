...
"""lef/simulation/REG8x16.spice を ngspice 用に直す（M カード -> XM 呼び出し）。
  ...
  usage: python3 $APRTOOLS/char/mkmemsrc.py lef/simulation/REG8x16.spice \
                 -o $APRTOOLS/char/cells_mem/REG8x16_src.spi
...
# ★ import しただけで argparse を走らせない（import 掃きだしが使えなくなる）
