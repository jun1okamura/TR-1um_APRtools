...
pins, which route_top_pins.py drops as bare M2PIN markers with
no M1 landing at all (verify_connectivity.py's locate_m1() alone
reports every one of them as "PIN NOT FOUND ON M1").

Usage:
    python3 verify_connectivity_m1m2.py <gds> <pin_map.json> <scan_y_lo> <scan_y_hi> [<scan_w>]
"""
