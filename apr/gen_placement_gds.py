...
LEF/placement.json (schema: {"rows": [[...row0...], ...]}).
"""
...
OUT_GDS = _cfg.artifact("i2c_slave_async_placement.gds")
...
# v3 update: route_channels.py's via_1-based jog mechanism claims a
